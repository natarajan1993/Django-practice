...
def profile(request):
    ...
    if request.method == 'POST':
        ...
        p_form = ProfileUpdateForm(request.POST,request.FILES, instance = request.user.profile) # Send the username and email data to the form fields to be pre-populated
